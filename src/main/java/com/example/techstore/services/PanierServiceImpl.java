...
public class PanierServiceImpl implements PanierService {
    ...
    @Override
    public List<Produit> getPanierForUser(Long userId) {
    ...
    @Override
    @Transactional
    public void addToPanier(Long userId, Long produitId) {
        User user = userRepository.findById(userId)
            .orElseThrow(() -> new RuntimeException("User not found"));
    ...
    @Override
    @Transactional
    public void updatePanierItem(Long userId, Long produitId, Integer quantity) {
        User user = userRepository.findById(userId)
            .orElseThrow(() -> new RuntimeException("User not found"));
    ...
    @Override
    @Transactional
    public void removeFromPanier(Long userId, Long produitId) {
        User user = userRepository.findById(userId)
            .orElseThrow(() -> new RuntimeException("User not found"));
